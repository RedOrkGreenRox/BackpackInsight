# [Справочник предметов v3.1.0 (items_3_1_0.json)](../../../Backend/DB/items_3_1_0.json)

## Назначение
Статический справочник всех предметов **Backpack Brawl** версии игры 3.1.0. Структура: `{appVersion, buildNumber, exportDate, language, embargoed, itemCount, items:[...]}`.
