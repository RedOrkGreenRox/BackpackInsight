# [Контроллер filter chips](../../../../../../../../Frontend/Web/ground/branches/items/_items/managers/runtime/multiselect-filter-controller.ts)

## Назначение
Создаёт кнопки фильтров, обрабатывает click, замену focused token, placeholder slots, sort toggles и `...` для типов.
