# [Парсер строгого запроса](../../../../../../../../Frontend/Web/ground/branches/items/_items/managers/filter/query-parser.ts)

## Назначение
Парсит логические выражения `[]`, `!`, `&`, `|`, `AND/OR/NOT`, `И/ИЛИ/НЕ` в AST.
