# [Справочник предметов v5.0.0 (items_5_0_0.json)](../../../Backend/DB/items_5_0_0.json)

## Назначение
Статический справочник всех предметов **Backpack Brawl** версии игры 5.0.0. Структура: `{appVersion, buildNumber, exportDate, language, embargoed, itemCount, items:[...]}`.
