...
BEAUTIFUL_NAMES = {
    ...
    "old Python profile parser.py": "Фабрика профилей",
    ...
    "items_logic.test.ts": "Тест: Логика списка предметов",
    ...
    "_items.scss": "Стили списка предметов",
    ...
    "items.scss": "Стили списка предметов",
